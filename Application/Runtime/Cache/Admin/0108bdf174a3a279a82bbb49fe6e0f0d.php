                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select class="form-control m-b kow" name="father_c_name">
                                    ...
                                    <?php if(is_array($menu_list)): foreach($menu_list as $key=>$vo): ?><option value="<?php echo ($vo["m_id"]); ?>"><?php echo ($vo["m_name"]); ?></option>
                                        <?php if($vo["kid_list"] != null): if(is_array($vo["kid_list"])): foreach($vo["kid_list"] as $key=>$v): ?><option value="<?php echo ($v["m_id"]); ?>"> |—— <?php echo ($v["m_name"]); ?></option><?php endforeach; endif; endif; endforeach; endif; ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input id="controller_name" name="controller_name" class="form-control" type="text" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">方法名：</label>
                            <div class="col-sm-4">
                                <input id="method_name" name="method_name" class="form-control" type="text" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">是否显示菜单：</label>
                            <div class="col-sm-6">
                                是 <input checked type="radio" value="1" name="is_show">&nbsp; 否 <input type="radio" value="0" name="is_show">
                            </div>
                        </div>
                        <div class="form-group">
