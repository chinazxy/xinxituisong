                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="table-responsive">
                            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                ...
                                <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr class="user_<?php echo ($v["id"]); ?>">


                                        <td class="center">
                                            <?php echo ($v["sr_realname"]); ?>
                                        </td>
                                        <td class="center ">
                                            <?php echo ($v["nickname"]); ?>
                                        </td>
                                        <td><?php echo ($v["sr_mobile"]); ?></td>
                                        <td class="hidden-480"><?php echo ($v["sr_idcard"]); ?></td>
                                        <td><?php echo ($v["sr_lev"]); ?></td>

                                        <td class="hidden-480 icon_<?php echo ($v["id"]); ?>">
                                            <?php if($v["is_bind"] == 1): ?><span class="label label-sm label-info arrowed arrowed-righ">正常</span>
                                                <?php elseif($v["is_bind"] == 2): ?>
                                                    <span class="label label-danger arrowed">拒绝</span>
                                                <?php elseif($v["is_bind"] == 0): ?>
                                        ...
                                        <td>
                                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                <?php if($v["is_bind"] != 1): ?><a onclick="pass(<?php echo ($v["id"]); ?>)" class="blue pass_<?php echo ($v["id"]); ?>" >
                                                        <i class="icon-ok bigger-130"></i>
                                                    </a><?php endif; ?>


                                                <a class="green" href="<?php echo U('Seller/editUser' , array('id' => $v['id']));?>">
                                                    <i class="icon-pencil bigger-130"></i>
                                                </a>
                                                <?php if($v["is_bind"] == 0): ?><a onclick="del(<?php echo ($v["id"]); ?>)" class="red refuse_<?php echo ($v["id"]); ?>" >
...
<script>
    ...
    function pass(id){
        if (confirm('是否通过审核？')){
            $.ajax({
                url : "<?php echo U('Seller/passUser');?>",
                type : "POST",
                dataType : "JSON",
                data : {id : id },
                success : function (e) {
