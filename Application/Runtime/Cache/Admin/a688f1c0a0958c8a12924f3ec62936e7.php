            ...
            <ul class="nav ace-nav">
                ...
                <li class="light-blue">
                    ...
                    <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        ...
                        <li class="active">
                            <a href="/index.php/Admin/Company/moPassword">
                                <i class="icon-cog"></i>
                                修改密码
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="/index.php/Admin/Company/logout">
                                <i class="icon-off"></i>
                                退出
                            </a>
                        </li>
                            ...
                            <div class="">
                                <div class="widget-main">
                                            ...
                                            <form class="form-horizontal" id="validation-form" method="">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-12 col-sm-9">
                                                        <div class="clearfix">
                                                            <input type="text" value="<?php echo ($info["username"]); ?>" name="username" id="username" class="col-xs-12 col-sm-6" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-12 col-sm-9">
                                                        <div class="clearfix">
                                                            <input type="password" disabled name="password" id="password" class="col-xs-12 col-sm-4" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-12 col-sm-9">
                                                        <div class="clearfix">
                                                            <input type="password" disabled name="password2" id="password2" class="col-xs-12 col-sm-4" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-12 col-sm-9">
                                                        <div class="input-group">
                                                            <input type="text" value="<?php echo ($info["mobile"]); ?>" id="phone" name="phone" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="idcard">身份证号:</label>

                                                    <div class="col-xs-12 col-sm-9">
                                                        <div class="clearfix">
                                                            <input type="text" value="<?php echo ($info["idcard"]); ?>" id="idcard" name="idcard" class="col-xs-12 col-sm-6" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="state">选择职位：</label>

                                                    <div class="col-xs-12 col-sm-9">
                                                        <select id="state" name="group" class="select2 col-sm-3" data-placeholder="Click to Choose...">

                                                            <?php if(is_array($group_list)): foreach($group_list as $key=>$v): ?><option value="<?php echo ($v["role_id"]); ?>" <?php if(($info["role_id"]) == $v["role_id"]): ?>selected<?php endif; ?>><?php echo ($v["role_name"]); ?></option><?php endforeach; endif; ?>
                                    ...
                                    <div class="clearfix col-md-offset-3 col-md-9">
                                        <button class="btn btn-info" onclick="edit(<?php echo ($info["admin_id"]); ?>)">
                                            <i class="icon-ok"></i>
                                            修改
                                        </button>
...
<script>
    function edit(id){
        ...
        if (name == ""){
            swal({title:"提示",text:"用户名不能为空",type:"error"})
        }
        if (phone == ""){
        ...
        if (group == ""){
            swal({title:"提示",text:"请选择所属用户组",type:"error"})
        }

        $.ajax({
            url : "<?php echo U('Company/updateUser');?>",
            type : "POST",
            dataType : "JSON",
            data : {name : name , phone : phone , idcard : idcard , group : group , admin_id : id},
            success : function (e) {
                if (e.res == 1){
