            ...
            <ul class="nav ace-nav">
                ...
                <li class="light-blue">
                    ...
                    <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        ...
                        <li class="active">
                            <a href="/index.php/Admin/Index/moPassword">
                                <i class="icon-cog"></i>
                                修改密码
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="/index.php/Admin/Index/logout">
                                <i class="icon-off"></i>
                                退出
                            </a>
                        </li>
                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" placeholder="手机号" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="form-field-1" placeholder="身份证" class="col-xs-10 col-sm-5" />
                                </div>
                            </div>
