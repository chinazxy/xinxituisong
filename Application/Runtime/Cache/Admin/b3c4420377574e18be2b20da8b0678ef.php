                                                ...
                                                <div class="step-pane active" id="step1">
                                                    ...
                                                    <form class="form-horizontal" id="validation-form" method="">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xs-12 col-sm-9">
                                                                <div class="clearfix">
                                                                    <input type="text" id="idcard" name="idcard" class="col-xs-12 col-sm-6" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xs-12 col-sm-9">
                                                                <select id="state" name="group" class="select2 col-sm-3" data-placeholder="Click to Choose...">
                                                                    <option value="">&nbsp;</option>
                                                                    <?php if(is_array($group_list)): foreach($group_list as $key=>$v): ?><option value="<?php echo ($v["role_id"]); ?>"><?php echo ($v["role_name"]); ?></option><?php endforeach; endif; ?>
...
<script>
    function add(){
        ...
        if (password1 == ""){
            swal({title:"提示",text:"密码不能为空",type:"error"})
        }
        if(password1 != password2){
            swal({title:"提示",text:"两次密码不一致",type:"error"})
        }
        if (phone == ""){
        ...
        $.ajax({
            url : "<?php echo U('Company/addUser');?>",
            type : "POST",
            dataType : "JSON",
            data : {name : name , password1 : password1 , phone : phone , idcard : idcard , group : group},
            success : function (e) {
                if (e.res == 1){
