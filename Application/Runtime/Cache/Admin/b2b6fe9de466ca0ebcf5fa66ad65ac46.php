                ...
                <div class="form-horizontal">
                    <div class="row col-xs-12 pull-right  ">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input name="title" id="title" value="<?php echo ($info["news_title"]); ?>" class="col-xs-12 col-sm-6" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right">经销商等级 </label>

                            <div class="col-sm-9">
                                <?php echo ($info["seller_group"]); ?>
                            </div>
                        </div>

                        <div class="form-group">

                            <label class="col-sm-2 control-label no-padding-right" for="">文章详情 </label>
                            <div class="col-sm-8 ">
...
<script>
    function submit(){
        ...
        $.ajax({
            ...
            type : "POST",
            dataType : "JSON",
            data : {title : title , sellers : sellers , content : content},
            success : function (e) {
                if (e.res == 1){
