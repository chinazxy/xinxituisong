                        ...
                        <div class="table-responsive">
                            <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                                ...
                                <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr class="user_<?php echo ($v["id"]); ?>">
                                        ...
                                        <td class="hidden-480"><?php echo ($v["op_type"]); ?></td>
                                        <td><?php echo ($v["op_content"]); ?></td>

                                        <td class="hidden-480">
                                            <?php if($v["op_isdeal"] == 1): ?><span class="label label-sm label-info arrowed arrowed-righ">已处理</span>
                                                <?php else: ?>
                                                <span class="label label-sm label-info arrowed arrowed-righ">未处理</span><?php endif; ?>

                                        </td>
                                        <td class="remark_<?php echo ($v["id"]); ?>"><?php echo ($v["op_remark"]); ?></td>
                                        <td class="deal_<?php echo ($v["id"]); ?>">
                                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                    <?php if($v["op_isdeal"] == 0): ?><a class="green" onclick="remark(<?php echo ($v["id"]); ?>)">
