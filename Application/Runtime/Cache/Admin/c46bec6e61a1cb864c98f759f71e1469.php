            ...
            <ul class="nav ace-nav">
                ...
                <li class="light-blue">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <img class="nav-user-photo" src="/Public/assets/avatars/user.jpg" alt="<?php echo ($admin_name); ?>'s Photo" />
                    ...
                    <ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
                        ...
                        <li class="active">
                            <a href="/index.php/Admin/Group/moPassword">
                                <i class="icon-cog"></i>
                                修改密码
                            </a>
                        </li>
                        ...
                        <li>
                            <a href="/index.php/Admin/Group/logout">
                                <i class="icon-off"></i>
                                退出
                            </a>
                        </li>
                            ...
                            <div class="">
                                <div class="widget-main">
                                            ...
                                            <form class="form-horizontal" id="validation-form" method="">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-12 col-sm-9">
                                                        <div class="clearfix">
                                                            <input type="text" value="<?php echo ($info["role_name"]); ?>" name="group_name" id="group_name" class="col-xs-12 col-sm-6" />
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-12 col-sm-9">
                                                        <div class="input-group">
                                                            <textarea name="desc" id="desc" cols="30" rows="10"><?php echo ($info["role_desc"]); ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-12 col-sm-9">
                                                        <select id="state" name="parent_id" class="select2 col-sm-3" data-placeholder="Click to Choose...">
                                                            ...
                                                            <?php if(is_array($list)): foreach($list as $key=>$v): ?><option value="<?php echo ($v["role_id"]); ?>" <?php if(($info["parent_id"]) == $v["role_id"]): ?>selected<?php endif; ?> ><?php echo ($v["role_name"]); ?></option><?php endforeach; endif; ?>
                                    ...
                                    <div class="clearfix col-md-offset-3 col-md-9">
                                        <button class="btn btn-info" onclick="submit(<?php echo ($info["role_id"]); ?>)">
                                            <i class="icon-ok"></i>
                                            提交
                                        </button>
...
<script>
    ...
    function submit(role_id){
        ...
        $.ajax({
            url : "<?php echo U('Group/updateGroup');?>",
            type : "POST",
            dataType : "JSON",
