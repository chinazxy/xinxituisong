                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row col-xs-12 pull-right  ">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="title" id="title" placeholder="文章标题" class="col-xs-12 col-sm-6" type="text">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <?php if(is_array($seller_lev)): foreach($seller_lev as $k=>$v): ?><label>
...
<script>
    function submit(){
        ...
        $.ajax({
            ...
            error : function (e) {
                swal({title:"提示",text:"发布失败，网络错误，请重试",type:"error"})
            }
        })
